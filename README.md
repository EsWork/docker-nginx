...
|[![](https://images.microbadger.com/badges/version/eswork/nginx:1.14.2-lt.svg)](https://microbadger.com/images/eswork/nginx:1.14.2-lt "Get your own version badge on microbadger.com")|[![](https://images.microbadger.com/badges/image/eswork/nginx:1.14.2-lt.svg)](https://microbadger.com/images/eswork/nginx:1.14.2-lt "Get your own image badge on microbadger.com")

## Supported tags and respective `Dockerfile` links

- [`latest` , `1.14.2` (1.14.2/Dockerfile)](https://github.com/EsWork/docker-nginx/blob/master/Dockerfile)
- [(1.14.2-lt/Dockerfile)](https://github.com/EsWork/docker-nginx/blob/master/Dockerfile.lt)
